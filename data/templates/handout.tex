...
\newlength{\drop}
\newcommand{\titleDevalot}{%
\begingroup
  \centering
  \vspace*{\drop}
  \HRule \\[1pt]
  {\huge \bfseries {$title$}}\\[1pt]
  $if(subtitle)${\large \bfseries {$subtitle$}}\\[1pt]$endif$
  \HRule \\[1pt]
  ...
  $else$
    \includegraphics[height=6cm]{$logodevalotpdf$}\\[1cm]
  $endif$   
  \vfill
